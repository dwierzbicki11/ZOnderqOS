...
static class Program
{
    ...
    static int Main()
    {
        try
        {
            ...
            Require(roots.Count == 2, "multifunction host controller must expose every present root bus");
            Require(roots[0].Id.Address == "00:00.0" && roots[1].Id.Address == "02:03.0", "multifunction host root discovery mismatch");
