...
| N7 | DHCP | lease acquisition and applied network configuration | IN PROGRESS |
...
N1 is complete and verified on exact SHA `6db386000020a7e5e2652994af8dbfd74a6f4556`. N2 is complete and verified on exact SHA `3159db51e128310b9b0d14805223c7066cba6f7a`. N3 is complete and verified on exact SHA `566d5d932878ace911e8f002144d8ef4c8b07540`. N4 is complete and verified on exact SHA `cb77d363aa4a28396759834ea06932138b8ec52a`. N5 is complete and verified on exact SHA `4d55cb7beafa899ddf3ff66590485a98d2e75775`. N6 is complete and verified on exact SHA `bb292d50e96303b3230c2fc729594ef31b2fe731`: GitHub Actions `Network stage N6 UDP` run #1 completed successfully, including patched Cosmos raw-RX runtime preparation, isolated x64 N6 ISO build, real QEMU UDP TX/RX runtime proof, and evidence upload. N7 DHCP is now the only active networking stage. Its completion gate requires real DHCP lease acquisition from a controlled QEMU peer, validation and application of the offered IPv4 configuration by the guest, runtime evidence on the exact PR-head SHA, and green GitHub Actions. N8 and N9 remain blocked until their predecessors are green; Phase 2 remains blocked until N9.
